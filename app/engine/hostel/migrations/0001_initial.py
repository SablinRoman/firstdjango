# Generated by Django 3.0.2 on 2020-04-03 02:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_status', models.CharField(blank=True, choices=[('Студент', 'Студент'), ('Заочник', 'Заочник'), ('Семейник', 'Семейник'), ('Расселитель', 'Расселитель'), ('Староста этажа', 'Староста этажа'), ('Актив этажа', 'Актив этажа'), ('Санитарная комиссия', 'Санитарная комиссия'), ('СООПР', 'СООПР')], db_index=True, max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.IntegerField(blank=True, db_index=True)),
